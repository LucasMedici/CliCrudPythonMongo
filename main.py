...
def login():
    nome = input('Nome: ')
    senha = input('Senha: ')
    tempEx = int(input('Digite o tempo de expiração (segs): '))

    
    conR.setex("sessao", tempEx, nome+";"+senha)
    


    
while (conR.get("sessao") == None):
    print("--------------")
    print("USUÁRIO NÃO ESTÁ LOGADO, DESEJA SE LOGAR?")
    print("1- LOGIN")
    print("2- SAIR")
    print("--------------")
    opcao_selecionada = input("Selecione a tabela que deseja utilizar: ")
